...
const Contactus = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_xk7ctjs', 'template_sn1yw3m', form.current, '_2Z55VrG2rAsYpuWm')
      .then((result) => {
          console.log(result.text);
          console.log("Your message has been sent sucessfully we will contact you soon!");
      }, (error) => {
          console.log(error.text);
          console.log("Oops something went wrong message is not sent!");
      });
  };
  return (
 <div>
 ...
 <nav className="navbar navbar-expand-lg bg-dark navbar-light d-none d-lg-block" id="templatemo_nav_top">
  ...
  <div className="container-fluid bg-light py-5">
    <div className="col-md-6 m-auto text-center">
      ...
      <p>
      We are there for to help you always!
      </p>
    </div>
  </div>
  {/* Start Contact */}
  <div className="container py-5">
    <div className="row py-5">
      <form className="col-md-9 m-auto" role="form" ref={form} onSubmit={sendEmail}>
        <div className="row">
          <div className="form-group col-md-6 mb-3">
            <label htmlFor="inputname">Name</label>
            <input type="text" className="form-control mt-1" id="name" name="user_name" placeholder="Name" required />
          </div>
          <div className="form-group col-md-6 mb-3">
            <label htmlFor="inputemail">Email</label>
            <input type="email" className="form-control mt-1" id="email" name="user_email" placeholder="Email" required/>
          </div>
        </div>
        <div className="mb-3">
          <label htmlFor="inputsubject">Subject</label>
          <input type="text" className="form-control mt-1" id="subject" name="subject" placeholder="Subject" required/>
        </div>
        <div className="mb-3">
          <label htmlFor="inputmessage">Message</label>
          <textarea className="form-control mt-1" id="message" name="message" placeholder="Message" rows={8} defaultValue={""} required/>
        </div>
        <div className="row">
