  ...
  <Container>
      ...
      <Form onSubmit={handleFormSubmit}>
        <Form.Group controlId="formTodo">
          ...
          <Form.Control type="text" placeholder="Enter todo" value={todo} onChange={handleInputChange} />
        </Form.Group>
        <br></br>
      ...
      <ListGroup className="my-5">
        {todos.map((todo, index) => (
          <ListGroup.Item key={index}>
           ...
           <Button variant="danger" className="float-right" onClick={() => handleDeleteTodo(index)}>
              Delete
            </Button>
          </ListGroup.Item>
        ))}
